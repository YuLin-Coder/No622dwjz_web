          ...
          <div class="layui-card-body" pad15>
             <form action="AdminUserServlet?action=addFeedWay" method="post" >
              ...
              <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                  <input type="text" name="name" id="name" value="${way.animal_name}"  lay-verify="required" lay-verType="tips" class="layui-input" readonly>
                </div>
             ...
             <div class="layui-form-item">
              ...
              <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                   <textarea name="content" style="width:400px" id="feedWay"  class="layui-textarea" readonly>${way.wyfs}</textarea>
                </div>
              </div>
